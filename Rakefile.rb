...
exec :checkout_habanero do |cmd| #command to check out habanero source using SVN
	...
	cmd.parameters %q(checkout "http://delicious:8080/svn/habanero/Habanero/branches/v2.5" temp/Habanero/branches/v2.5/ --username chilli --password chilli) 
end
...
msbuild :msbuild_smooth do |msb| #builds smooth with msbuild
  ...
  msb.solution = "source/SmoothHabanero.sln"
  msb.verbosity = "quiet"
end
