...
namespace AutoMappingHabanero.Test
{
    ...
    public class TestTypeWrapper
    {
        ...
        public void Test_BaseType_ShouldReturnFromType()
        {
            ...
            //---------------Test Result -----------------------
            Assert.AreSame(expectedBaseType, baseType.GetUnderlyingType());
        }
        [Test]
        ...
        public void Test_IsBaseTypeLayerSuperType_WhenInheritsDirectlyFromBO_ShouldReturnTrue()
        {
            ...
            Assert.AreEqual(expectedBaseType, type.BaseType);
            //---------------Execute Test ----------------------
            var isBaseTypeLayerSuperType = wrapper.IsBaseTypeLayerSuperType;
            //---------------Test Result -----------------------
...
//            Assert.IsFalse(type.IsAbstract);
        ...
        public void Test_GetProperty_ShouldReturnFromType()
        {
            ...
            //---------------Test Result -----------------------
            Assert.AreEqual(expectedGetProperty, getProperty.PropertyInfo);
        }
        [Test]
        ...
        public void Test_GetUnderlyingSystemType_ShouldReturnType()
        {
            ...
            //---------------Assert Precondition----------------
            //---------------Execute Test ----------------------
            var underlyingType = wrapper.GetUnderlyingType();
            //---------------Test Result -----------------------
        ...
        public void Test_GetPKPropName_WhenInheritance_ShouldBasePropName()
        {
            ...
            Assert.IsFalse(typeWrapper.IsBaseTypeLayerSuperType);
            //---------------Execute Test ----------------------
        ...
        public void Test_AssemblyName_ReturnsCorrectName()
        {
            ...
            //---------------Test Result -----------------------
            Assert.AreEqual("AutoMappingHabanero.Test", assemblyName);
        }
        ...
        {
            return TestUtilsShared.GetRandomBoolean();
        }
