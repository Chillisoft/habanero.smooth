...
//            AssertMockPropSetupCorrectly(propertyWrapper, ownerType, relatedType, relationshipName, reverseRelName);
        ...
        [Test]
        public void TestAccept_Map_WhenRelationshipTypeDefined_ShouldSetToComposition()
        {
            //---------------Set up test pack-------------------
            ...
            var onToManyAtt = propertyWrapper.GetAttribute<AutoMapOneToOneAttribute>();
            Assert.AreEqual(RelationshipType.Aggregation, onToManyAtt.RelationshipType);
            //---------------Execute Test ----------------------
            var relationshipDef = propertyWrapper.MapOneToOne();
            //---------------Test Result -----------------------
