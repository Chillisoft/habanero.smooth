...
// ReSharper disable InconsistentNaming
        ...
        {
            //---------------Set up test pack-------------------
            NewClassDefBuilder<Car> classDefBuilder = GetClassDefBuilder();
            //---------------Assert Precondition----------------
        ...
        public void Test_CreateClassDef_ShouldUseDefaults()
        {
            ...
            //---------------Execute Test ----------------------
            var classDef = GetClassDefBuilder().WithPrimaryKey(c => c.VehicleID).Build();
            //---------------Test Result -----------------------
...
//        }
        ...
        private static NewClassDefBuilder<Car> GetClassDefBuilder()
        {
