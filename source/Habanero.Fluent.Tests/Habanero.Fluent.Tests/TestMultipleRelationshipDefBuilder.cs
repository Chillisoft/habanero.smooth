...
namespace Habanero.Fluent.Tests
{
    ...
    public class TestMultipleRelationshipDefBuilder
    {
        ...
        public void Test_Build_ShouldUseDefaults()
        {
            ...
            //---------------Execute Test ----------------------
            MultipleRelationshipDef multipleRelationshipDef = GetMultipleRelationshipDefBuilder<Car>(relationshipName)
                                                                .WithRelatedType<Car>()
                                                                .Build();
        ...
        public void Test_Build_WithLambdaProp_ShouldSetRelationshipName()
        {
            ...
            //---------------Execute Test ----------------------
            MultipleRelationshipDef multipleRelationshipDef = new MultipleRelationshipDefBuilder<Car>()
