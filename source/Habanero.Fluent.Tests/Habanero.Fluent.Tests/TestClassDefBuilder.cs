...
//        }
        ...
        [Test]
        public void Test_CreateClassDef_ShouldUserDefaults()
        {
            //---------------Set up test pack-------------------
            //---------------Assert Precondition----------------

            //---------------Execute Test ----------------------
            ClassDef classDef = new ClassDefBuilder<Car>().Build();
            //---------------Test Result -----------------------
        ...
        public void Test_Build_WithPropertyLambda_ShouldBuildProp()
        {
            ...
            ClassDef classDef = classDefBuilder
                ...
                .Build();
            //---------------Test Result -----------------------
            Assert.GreaterOrEqual(classDef.PropDefcol.Count, 1, "Should have pros");
        ...
        public void Test_CreateClassDef_WithRelationshipsLambda_ShouldBuildRelationships()
        {
            ...
            ClassDef classDef = classDefBuilder
                    ...
                    .WithMultipleRelationship(c => c.Drivers, typeof(Driver)).Return()
                    .Build();
            //---------------Test Result -----------------------
            Assert.AreEqual(2, classDef.RelationshipDefCol.Count);
            IRelationshipDef relationshipDef1 = classDef.RelationshipDefCol["SteeringWheel"];
            Assert.IsNotNull(relationshipDef1.RelationshipName);
            Assert.AreEqual("SteeringWheel", relationshipDef1.RelatedObjectClassName);
            IRelationshipDef relationshipDef2 = classDef.RelationshipDefCol["Drivers"];
        ...
        public void Test_CreateClassDef_WithPrimaryKey_IntProp_ShouldBuildPrimary_WithIsGuidObjectID_False()
        {
            ...
            IPropDef def = classDef.PrimaryKeyDef[0];
