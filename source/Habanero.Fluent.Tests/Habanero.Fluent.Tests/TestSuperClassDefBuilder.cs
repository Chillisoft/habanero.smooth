...
namespace Habanero.Fluent.Tests
{
    ...
    public class TestSuperClassDefBuilder
    {
        ...
        public void Test_Construct_ShouldCreate()
        {
            ...
            //---------------Execute Test ----------------------
            var superClassDefBuilder = new SuperClassDefBuilder<Car>();
            //---------------Test Result -----------------------
            Assert.IsNotNull(superClassDefBuilder);
        }

        private SuperClassDefBuilder<T> GetSuperClassDefBuilder<T>() where T : BusinessObject
        {
            return new SuperClassDefBuilder<T>();
        }
