...
namespace Habanero.Smooth
{
    ...
    public class OneToOneAutoMapper
    {
        ...
        {
            //If defined as Composition or Aggregation then Prevent Delete.
            if (IsDefinedAsCompositionOrAggregation()) return DeleteParentAction.Prevent;
            //If defined as Association or reverse rel defined as Comp or Agg then Do Nothing.
           if (IsDefinedAsAssociation()) return DeleteParentAction.DoNothing;
        ...
        public bool OwningBoHasForeignKey
        {
            get
            {
                ...
                //If defined as Association or reverse rel defined as Comp or Agg then True.
                if (IsDefinedAsAssociation()) return true;
        ...
        private bool IsDefinedAsCompositionOrAggregation(PropertyWrapper propertyWrapper)
        {
            if(propertyWrapper == null) return false;
        ...
        /// <summary>
        /// If this relationship is defined as Association or
        /// the reverse relationship is defined as Composition then return true.
        /// </summary>
        /// <returns></returns>
