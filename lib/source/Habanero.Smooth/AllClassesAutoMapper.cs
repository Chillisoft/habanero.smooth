...
//            _classDefCol = new ClassDefCol();
            foreach (var classDef in typesToBeMapped.Select(type => type.MapClass()))
            {
                MergeClassDefs(classDef);
            }

            MapAllReverseRelationships();
            return ClassDefCol;
        }

        private void MergeClassDefs(IClassDef classDef)
        {
        ...
        private void MapAllReverseRelationships()
        {
            foreach (var classDef in ClassDefCol)
            {
        ...
        public static IRelationshipDef CreateReverseRelationship(ClassDefCol classDefCol, IClassDef classDef, IRelationshipDef relationship)
        {
            ...
            if (relPropDef != null)
            {
                ...
                bool hasPropDef = relatedClassDef.PropDefcol.Any(
